    ...
    protected void onPostExecute(Boolean isParsed) {
        ...
        if(isParsed){
            ...
            if(!Payment_type.isEmpty()) {
                GridViewAdapterAllPayment adapter = new GridViewAdapterAllPayment(c, Date, Payment_type, Amount, tv);
                ...
                gv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        Toast.makeText(c, Date.get(i) + " : Selected", Toast.LENGTH_SHORT).show();
                    }
                });
            }
            else {
    ...
    private Boolean parse(){
        try {
            ...
            for (int i = 0; i < ja.length(); i++) {
                ...
                String _paymentType = jo.getString("PaymentMode_Name");
                String _amount = jo.getString("Payment_Amount");
                Date.add(_date);
