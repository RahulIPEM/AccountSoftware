...
public class JSONDownloaderSP extends AsyncTask<Void,Void,String> {
    ...
    public JSONDownloaderSP(Context c, String jsonURL, Spinner sp, TextView txtBookTitle, TextView txtAuthorName, TextView txtIsbnNo) {
        this.c = c;
    ...
    protected void onPostExecute(String jsonData) {
        ...
        if(jsonData.toString().startsWith("Error")){
            ...
            new JSONParser(c,jsonData,sp,txtBookTitle,txtAuthorName,txtIsbnNo).execute();
        }
    }
